...
exports.DirectMessagagingService = void 0;
const Container_1 = __importDefault(require("../../core/dependencies/Container"));
const error_service_1 = require("../../core/errors/error.service");
const errors_1 = require("../../core/errors/errors");
class DirectMessagagingService {
    constructor() {
        this.block = "directMessaging.service";
    }
    handleOutGoingMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, error_service_1.handleServiceError)(error, this.block, "outgoing", { message });
                throw error;
            }
        });
    }
}
exports.DirectMessagagingService = DirectMessagagingService;
